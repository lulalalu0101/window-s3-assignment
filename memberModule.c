...
void getMemberData() {
    ...
    FILE* firstOutputMember = fopen("memberData.txt", "r");
...
void memberLogin() {
    ...
    FILE* tempMember = fopen("tempMember.bin", "wb");
...
void memberMenu() {
    ...
    FILE* tempMember = fopen("tempMember.bin", "rb");
...
void memberModify(int memberIndex) {
    ...
    FILE* outputMember = fopen("memberData.txt", "r");
    ...
    // Input new data
    FILE* updateMember = fopen("memberData.txt", "w");
...
void purchaseHistory() {
    ...
    // Get ticket list
    FILE* outputTicket = fopen("ticketData.txt", "r");
