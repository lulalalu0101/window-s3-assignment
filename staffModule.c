...
void getStaffData() {
    ...
    FILE* firstOutputStaff = fopen("staffData.bin", "rb");
...
void staffLogin() {
    ...
    FILE* tempStaff = fopen("tempStaff.bin", "wb");
...
void staffMenu() {
    ...
    FILE* tempStaff = fopen("tempStaff.bin", "rb");
...
void modifyStaff(int staffIndex) {
    ...
    // Update staff data
    FILE* updateStaff = fopen("staffData.bin", "wb");
...
void updatePunchCard(int staffIndex) {
    ...
    FILE* updatePunchCard = fopen("punchCardData.bin", "ab");
...
void displayPunchCard(int staffIndex) {
    ...
    FILE* outputPunchCard = fopen("punchCardData.bin", "rb");
